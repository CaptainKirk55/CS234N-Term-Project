...
//using CS243N_Term_Project.UnitConversion;
...
namespace BITSClasses.AdditionalModels
{
    public class ShoppingList
    {
        ...
        private List<KeyValueItem> suppliers;
        ...
        public List<KeyValueItem> Suppliers
        {
            get
            {
        ...
        public ShoppingList(BitsContext dbContext, DateTime startDate, DateTime endDate)
        {
            ...
            this.suppliers = dbContext.Suppliers.OrderBy(s => s.Name)
                .Select(s => new KeyValueItem(s.SupplierId, s.Name)).ToList();
        }

        //Need weight convert and fluid convert

        //private ShoppingListItem CreateShoppingListItem(BitsContext dbContext, Ingredient i)
        //{
